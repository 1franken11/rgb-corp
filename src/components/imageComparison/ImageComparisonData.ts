export const imageComparisonsData = [
    {
      ...
      alt: 'Renovated kitchen flooring in Jacksonville, FL'
    },
    {
      ...
      alt: 'Modernized bathroom flooring in Jacksonville, FL'
    },
    {
      ...
      alt: 'Renovated living room flooring in Jacksonville, FL'
    }
  ]; 